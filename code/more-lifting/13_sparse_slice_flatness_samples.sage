# 13_sparse_slice_flatness_samples.sage
#
# Test flatness/saturation behavior for cubic families coming from generic
# points on the 7-coordinate sparse slice.
#
# Fixed rows:
#
#   [138, 139, 142, 143, 144, 146, 150, 157]
#
# The formal order tests show that generic points on the sparse slice have a
# cubic pattern G1,G2,G3 and no higher corrections through order 10.  Here we
# build the actual family ideal
#
#   J = (f_i + t G1_i + t^2 G2_i + t^3 G3_i)
#
# over GF(32003), saturate by t, and compare the saturated special fiber with
...
OUT_FILE = "cache/13_sparse_slice_flatness_samples.log"
...
pr("Sparse-slice flatness samples")
pr("-----------------------------")
