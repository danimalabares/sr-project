# 08_test_order4_from_saved_lift.sage
#
# Test whether the saved order-3 lift extends to order 4.
#
# Run from:
...
INPUT_FILE = "cache/one_order3_lift.sobj"
OUTPUT_FILE = "cache/one_order4_lift.sobj"

TARGET_ORDER = 4

# known generator corrections G_k, k=1,...,TARGET_ORDER-1
GEN_SOLUTION_NAMES = {1: "direction", 2: "psi_solution", 3: "chi_solution"}

# known syzygy corrections A_a, a=1,...,TARGET_ORDER-2
SYZ_SOLUTION_NAMES = {1: "alpha_solution", 2: "beta_solution"}

NEW_GEN_SOLUTION_NAME = "eta_solution"
NEW_SYZ_SOLUTION_NAME = "gamma_solution"
